<?php
    ...
    /* Uitstroom geld
    * return 1, als het gelukt is
    * return 2, als het gelukt is, maar weinig briefjes over
    * return 3, als er te weinig briefjes inzitten
                                ...
                                while ($row = $result->fetch_assoc()){
                                    if ($_SERVER["REQUEST_METHOD"] == "GET") {
                                        if($authkeyBank == $sltl){ 							                                                                //als key van bank is
                                            if($row['aantal_briefjes'] >= $hvhbrfj){
